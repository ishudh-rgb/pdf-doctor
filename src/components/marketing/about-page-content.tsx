  ...
  return (
    ...
    >
      <div className="grid gap-12 sm:grid-cols-2">
        <div>
          ...
          <p className="mt-4 leading-relaxed text-pd-muted">
            OnlyMyPDF was created to solve a simple problem: everyday PDF tasks shouldn&apos;t
      ...
      <section className="mt-16">
        <h2 className="text-center text-2xl font-bold text-pd-foreground">Why Choose OnlyMyPDF?</h2>
      ...
      <section className="mt-16 rounded-2xl bg-pd-brand p-8 text-center text-white sm:p-12">
        ...
        <p className="mx-auto mt-3 max-w-xl text-white/85">
          Try OnlyMyPDF for free — no signup needed for basic tools.
        </p>
