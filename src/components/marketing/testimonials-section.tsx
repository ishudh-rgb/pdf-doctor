...
const TESTIMONIALS: Testimonial[] = [
  ...
  { name: "Liam O'Brien", role: "Startup Founder", country: "Ireland", flag: "🇮🇪", rating: 5, text: "We use OnlyMyPDF across our entire team. Batch processing and generous Pro file limits keep our workflow fast.", avatar: "LO", accent: "from-green-500 to-emerald-600" },
